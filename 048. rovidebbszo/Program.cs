...
namespace _048.rovidebbszo
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Kérek még egy szót és kiírom a rövidebbet! ");
            string szo2 = Convert.ToString(Console.ReadLine());

            if(szo1.Length < szo2.Length)
            {
                Console.WriteLine("Az első szó " + szo1 + " rövidebb, mint a második " + szo2 + " szó.");
            ...
            {
                Console.WriteLine("A második szó " + szo2 + " rövidebb, mint az első " + szo1 + " szó.");
